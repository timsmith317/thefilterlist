...
// that opened it. The picker is its own route now (so New Part can stack on
...
// it on focus.
//
// Shape: { field: 'asset' | 'part', value: <id> | null }
//   - value === null is meaningful for 'part' (the "None" selection).
